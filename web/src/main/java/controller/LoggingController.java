...
public class LoggingController extends HttpServlet {
	...
	protected void post(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
	...
	private void logActivity(HttpSession session, String text, String html, String hitId, String workerId,
			String assignmentId, HttpServletResponse response) throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
        ...
        .addChangeable(new ParaphraseLabelChanger(Controller.changeLablesManagers.get(hitId + workerId).getLables()));
		AddResult2Db2.addResponse(hitId, workerId, assignmentId, text, html, new Timestamp(System.currentTimeMillis()));
	   ...
	   private void logActivity(HttpSession session, String text, String html, String hitId, HttpServletResponse response) throws IOException {
